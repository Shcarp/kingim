...
type Watch struct {
	Service   string
	Callback  func([]kingim.ServiceRegistration)
	WaitIndex uint64
	Quit      chan struct{}
}
...
func (n *Naming) Find(name string, tags ...string) ([]kingim.ServiceRegistration, error) {
...
func (n *Naming) load(name string, waitIndex uint64, tags ...string) ([]kingim.ServiceRegistration, *api.QueryMeta, error) {
	...
	services := make([]kingim.ServiceRegistration, 0, len(catalogServices))
...
func (n *Naming) Register(s kingim.ServiceRegistration) error {
...
func (n *Naming) Subscribe(serviceName string, callback func([]kingim.ServiceRegistration)) error {
	n.Lock()
	defer n.Unlock()
...
func (n *Naming) watch(wh *Watch) {
	...
	var doWatch = func(service string, callback func([]kingim.ServiceRegistration)) {
